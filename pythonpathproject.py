...
"""
"""
Ron Amado, Amit Caspi, Roni Peri, Maya Yosef and Topaz Ben Atar.
YB-4
"""
...
def makealibrary(): 
    ...
    if path== "":  #במקרה של אנטר
       path=r"C:\Users\ADMIN\Desktop" #נתיב לשולחן הבית בהתאם למחשב
...
def main():
    makealibrary()
    jpgpath= r"C:\Users\ADMIN\Desktop\רון-עבודות\animals" #נתיב לספריית התמונות מסוג jpg
